...
// {
//     char configPinBuf[1024];
//     sprintf(configPinBuf, "config-pin p8.%d gpio", pinNumber);
//     runCommand(configPinBuf);
// }
...
{
    // Commented out as pins seem to already be set to GPIO at system startup.
    // configPinToGpio(pinNumber);
    sleepForMs(330);
